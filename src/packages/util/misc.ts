...
export function sanitize_html_attributes($, node): void {
  $.each(node.attributes, function () {
    ...
    const lowerName = attrName ? attrName.toLowerCase() : "";
    // remove all whitespace and control characters to detect obfuscated javascript:
    // e.g. "j a v a s c r i p t :" or "javascript\n:"
    // \s matches whitespace. \x00-\x1f matches control chars.
